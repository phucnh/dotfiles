...
plugins=(zsh-syntax-highlighting zsh-colors zsh-256color git brew docker git-extras git-flow github history osx sbt scala screen web-search aws)

# User configuration

# export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/scala/bin:/opt/activator"
